...
@RestController
@RequestMapping("/api/v1/categorias-despesas")
public class CategoriaDespesaController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "409", description = "Despesa já criada!")
    })
    @Operation(
            summary = "Criar categoria de despesas",
            description = "Rota para criar categoria de despesas"
    )
    @PostMapping
